...
- [[#lists][Lists]]
  ...
  - [[#remove-and-return-from-end-with-pop][Remove (and return) from end with ~pop~]]
  - [[#slicing-with-listartendstep][Slicing with ~li[start:end(:step)]~]]
...
- [[#dictionairies][Dictionairies]]
  ...
  - [[#adding-value-to-dictionairy][Adding value to dictionairy]]
...
- [[#errors-and-exception][Errors and Exception]]
  ...
  - [[#clean-up-using-finally][Clean up using ~finally~]]
