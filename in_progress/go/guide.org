...
func main() {
	a0 := []int{1, 2, 3}
	a1 := []int{1, 2, 3}
	printSlice("a0", a0) // a0: len=3 cap=3 [1 2 3]
	printSlice("a1", a1) // a1: len=3 cap=3 [1 2 3]
	mutatorWoPointer(a0)
	mutatorWPointer(&a1)
	printSlice("a0", a0) // a0: len=3 cap=3 [1 2 3]
	printSlice("a1", a1) // a1: len=4 cap=6 [1 2 3 8]
	...
	mutatorWPointer(&a1)
	printSlice("a1", a1) // a1: len=5 cap=6 [1 2 3 8 8] 
}
#+END_SRC
...
- AoC dag 13. Varöfr behövs pekare?!
